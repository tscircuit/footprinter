...
export const radial_def = base_def.extend({
  fn: z.string(),
  p: length.optional().default("1.6mm"),
  id: length.optional().default("0.7mm"),
  od: length.optional().default("1.25mm"),

  body_d: length.optional().default("5.0mm"),
  body_h: length.optional().default("12.5mm"),
})
...
export const radial = (
  ...
  const { p, id, od, body_d, body_h } = parameters
