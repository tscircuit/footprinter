...
const createManualDiodeFabricationNotes = (params: {
  ...
  const arrowBaseRatio = clamp(0.3 - tightPitchBoost * 0.03, 0.24, 0.3)
  const cathodeBarRatio = clamp(0.24 - tightPitchBoost * 0.03, 0.18, 0.24)
...
export const sod_def = base_def.extend({
  ...
  pl: z.string().default("1.10mm"),
  pw: z.string().default("1.10mm"),
