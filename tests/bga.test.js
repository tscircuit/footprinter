...
test("bga7_w8_h8_grid3x3_p1_missing(center,B1)", () => {
    const soup = fp
        ...
        .circuitJson();
    const svgContent = convertCircuitJsonToPcbSvg(soup);
    expect(svgContent).toMatchSvgSnapshot(import.meta.path, "bga7_w8_h8_grid3x3_p1_missing(center,B1)");
});
test("bga64_w10_h10_grid8x8_p1.27mm", () => {
    ...
    const svgContent = convertCircuitJsonToPcbSvg(soup);
    expect(svgContent).toMatchSvgSnapshot(import.meta.path, "bga64_w10_h10_grid8x8_p1.27mm");
});
