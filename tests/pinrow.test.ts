...
test("pinrow3_smd center pad width reproduces C78322", () => {
  const circuitJson = fp
    .string(
      "pinrow3_smd_p3.299968mm_pw1.7999964mm_pl5.7999884mm_centerpadwidth2.3999952mm_nopinlabels_rounded0",
    )
    .circuitJson()
...
test("pinrow3_smd center pad width reproduces C7464756", () => {
  const pads = fp
    .string(
      "pinrow3_smd_p1.299972mm_pw0.3999992mm_pl3.0999938mm_centerpadwidth1.1999976mm_nopinlabels_rounded0",
    )
    .circuitJson()
...
test("pinrow center pad width requires an odd single-row SMD layout", () => {
  expect(() => fp.string("pinrow3_centerpadwidth2mm").circuitJson()).toThrow(
    "requires an odd, non-sparse, single-row SMD pinrow",
  )
  expect(() =>
    fp.string("pinrow4_smd_centerpadwidth2mm").circuitJson(),
  ).toThrow("requires an odd, non-sparse, single-row SMD pinrow")
})
